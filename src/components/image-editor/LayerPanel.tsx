...
export const LayerPanel: React.FC<LayerPanelProps> = ({ isOpen, onClose, elements, selectedElementIds, onSelectElement, onToggleVisibility, onToggleLock, onRenameElement, onReorder }) => {
    ...
    return (
        <div
            ref={panelRef}
            className="absolute top-20 right-4 z-50 flex flex-col w-64 h-[calc(100vh-6rem)] backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl text-white overflow-hidden"
